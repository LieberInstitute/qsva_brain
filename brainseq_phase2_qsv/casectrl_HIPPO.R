...
pdf('pdf/hippo_voom_qsva.pdf', useDingbats = FALSE)
...
pdf('pdf/hippo_voom_qsva_noHGoldQSV.pdf', useDingbats = FALSE)
vGene = voom(dge,modQsva, plot=TRUE)
dev.off()
fitGene = lmFit(vGene)
eBGene = eBayes(fitGene)
...
## no qSVA
pdf('pdf/hippo_voom_noqsva_noHGoldQSV.pdf', useDingbats = FALSE)
vGene0 = voom(dge,mod, plot=TRUE)
dev.off()
fitGene0 = lmFit(vGene0)
eBGene0 = eBayes(fitGene0)
...
## no adjustment vars
pdf('pdf/hippo_voom_noadj_noHGoldQSV.pdf', useDingbats = FALSE)
vGeneNoAdj = voom(dge, with(colData(rse_gene), model.matrix( ~ Dx)), plot=TRUE)
dev.off()
fitGeneNoAdj = lmFit(vGeneNoAdj)
eBGeneNoAdj = eBayes(fitGeneNoAdj)
...
save(outGene, outGene0, outGeneNoAdj, file = "rdas/dxStats_hippo_filtered_qSVA_geneLevel_noHGoldQSV.rda")
...
pdf('pdf/hippo_voom_qsva_noHGoldQSV_matchHIPPO.pdf', useDingbats = FALSE)
vGene = voom(dge,modQsva, plot=TRUE)
dev.off()
fitGene = lmFit(vGene)
eBGene = eBayes(fitGene)
...
## no qSVA
pdf('pdf/hippo_voom_noqsva_noHGoldQSV_matchHIPPO.pdf', useDingbats = FALSE)
vGene0 = voom(dge,mod, plot=TRUE)
dev.off()
fitGene0 = lmFit(vGene0)
eBGene0 = eBayes(fitGene0)
...
## no adjustment vars
pdf('pdf/hippo_voom_noadj_noHGoldQSV_matchHIPPO.pdf', useDingbats = FALSE)
vGeneNoAdj = voom(dge, with(colData(rse_gene), model.matrix( ~ Dx)), plot=TRUE)
dev.off()
fitGeneNoAdj = lmFit(vGeneNoAdj)
eBGeneNoAdj = eBayes(fitGeneNoAdj)
...
save(outGene, outGene0, outGeneNoAdj, file = "rdas/dxStats_hippo_filtered_qSVA_geneLevel_noHGoldQSV_matchHIPPO.rda")
