...
load("/dcl01/lieber/RNAseq/Datasets/BrainSeq_hg38/Phase4and5/count_data/brainseq_phases4and5_hg38_rseExon_merged_n492.rda", verbose = TRUE)
load("/dcl01/lieber/RNAseq/Datasets/BrainSeq_hg38/Phase4and5/count_data/brainseq_phases4and5_hg38_rseJxn_merged_n492.rda", verbose = TRUE)
load("/dcl01/lieber/RNAseq/Datasets/BrainSeq_hg38/Phase4and5/count_data/brainseq_phases4and5_hg38_rseTx_merged_n492.rda", verbose = TRUE)
load('/dcl01/ajaffe/data/lab/qsva_brain/brainseq_phase4_5_qsv/rdas/brainseq_phase4_5_mPFC_qsvs_age17.Rdata', verbose = TRUE)

## Keep only the mPFC samples
keep_mPFC <- which(rse_gene$Region == 'mPFC')

## Check https://github.com/LieberInstitute/qsva_brain/blob/master/process_bsp4_5.R#L46-L48
stopifnot(all(table(rse_gene[, keep_mPFC[keepIndex]]$Dx) - c(38, 107, 60, 94) == 0))

## Drop samples absent in mod and modQsVA
rse_gene <- rse_gene[, keep_mPFC[keepIndex]]
rse_jxn <- rse_jxn[, keep_mPFC[keepIndex]]
rse_exon <- rse_exon[, keep_mPFC[keepIndex]]
rse_tx <- rse_tx[, keep_mPFC[keepIndex]]
...
## Fix the mod/modQsva
load('/dcl01/ajaffe/data/lab/qsva_brain/brainseq_phase4_5_qsv/rdas/brainseq_phase4_5_mPFC_cov_rse_age17.Rdata', verbose = TRUE)
...
pdf('pdf/voom_qsva_BSP4_5_mPFC_gene.pdf', useDingbats = FALSE)
...
pdf('pdf/voom_qsva_BSP4_5_mPFC_exon.pdf', useDingbats = FALSE)
...
pdf('pdf/voom_qsva_BSP4_5_mPFC_jxn.pdf', useDingbats = FALSE)
...
save(outGene, outExon, outJxn,outTx,
	file = "rdas/dxStats_filtered_qSVA_BSP4_5_mPFC.rda")
